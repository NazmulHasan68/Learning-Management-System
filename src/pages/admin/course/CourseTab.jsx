...
export default function CourseTab() {
  ...
  const SelectedCategory = (value) => {
    setcategory({ ...input, category: value });
  };
  const seletectCourseLevel = (value) => {
    setcategory({ ...input, courseLevel: value });
  };
        ...
        <div className="space-y-4 mt-5">
          ...
          <div>
            ...
            <Input
              ...
              onChange={changeEventHandler}
              placeholder="Ex. Become a fullstack developer in 6 month"
            />
          </div>
          <div>
            ...
            <div>
              ...
              <Select onValueChange={SelectedCategory}>
                ...
                <SelectContent className="bg-white">
                  ...
                  <SelectItem value="fullstact">
                    Fullstact Development
                  </SelectItem>
